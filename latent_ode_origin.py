...
class LatentODE(eqx.Module):
    ...
    def __init__(
        self, *, out_size, hidden_size, latent_size, width_size, depth, key, **kwargs
    ):
        ...
        self.rnn_cell = eqx.nn.GRUCell(out_size + 1, hidden_size, key=gkey)
    ...
    def sample(self, ts_history_test_i, observation_history_test_i, ts_forward_test_i, *, key):
        latent, mean, std = self._latent(ts_history_test_i, observation_history_test_i, key)
        return self._sample(ts_forward_test_i, latent)